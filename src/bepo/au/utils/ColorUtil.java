...
public class ColorUtil {
	enum Color{
	  ...
	  LIME(DyeColor.LIME, ChatColor.LIGHT_PURPLE), 
	  MAGENTA(DyeColor.MAGENTA, ChatColor.GOLD), 
	  ORANGE(DyeColor.ORANGE, ChatColor.LIGHT_PURPLE), 
	  PINK(DyeColor.PINK, ChatColor.DARK_PURPLE), 
