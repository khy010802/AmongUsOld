...
public class Util implements Listener{
	...
	public static boolean b_random() { return ran.nextBoolean();}
	...
	public static ItemStack createItem(Material mat, int amount, String name, List<String> lore, int num) {
...
////////////////////////////
	...
	public static void Stack(Inventory inv, int slot, Material mat, int amount, String name, List<String> lore,int num) {					
		inv.setItem(slot, createItem(mat, amount, name, lore,num));				
	}
	public static void Stack(Inventory inv, int slot, Material mat, int amount, String name, String lore,int num) {					
		inv.setItem(slot, createItem(mat, amount, name, Arrays.asList(lore),num));				
	}
